...
{
    public partial class FRM_CONSUL_GENERAL : Form
    {
        DataView oDv = new DataView();
        Metodos met = new Metodos();
        N_MAESTROS oSedN = new N_MAESTROS();
        N_REAL_INSUMOS oN = new N_REAL_INSUMOS();
        private static FRM_CONSUL_GENERAL _Instancia;
        public static FRM_CONSUL_GENERAL GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_CONSUL_GENERAL();
            }
            return _Instancia;
        }
        public FRM_CONSUL_GENERAL()
        {
            InitializeComponent();
            cbo_Sede();
            cbo_Cultivo();
