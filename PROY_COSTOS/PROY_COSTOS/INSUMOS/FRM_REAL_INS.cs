...
{
    public partial class FRM_REAL_INS : Form
    {
        ...
        private static FRM_REAL_INS _Instancia;
        public static FRM_REAL_INS GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_REAL_INS();
            }
            return _Instancia;
        }
        public FRM_REAL_INS()
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            met.importarExcel(dgvDatos, "REAL_INS");
        ...
        private void btnCargar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (cboIndicativo.Text == string.Empty)
                {
                    cboIndicativo.Focus();
                }
                else
