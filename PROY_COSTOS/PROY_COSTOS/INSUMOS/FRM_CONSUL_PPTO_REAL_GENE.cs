...
{
    public partial class FRM_CONSUL_PPTO_REAL_GENE : Form
    {
        DataView oDv = new DataView();
        Metodos met = new Metodos();
        N_MAESTROS oSedN = new N_MAESTROS();
        N_PPTO_REAL oN = new N_PPTO_REAL(); 
        private static FRM_CONSUL_PPTO_REAL_GENE _Instancia;
        public static FRM_CONSUL_PPTO_REAL_GENE GetInstancia()
        {
            if (_Instancia == null)
            {
                _Instancia = new FRM_CONSUL_PPTO_REAL_GENE();
            }
            return _Instancia;
        }
        public FRM_CONSUL_PPTO_REAL_GENE()
        {
            InitializeComponent();
            cbo_Sede();
            cbo_Cultivo();
        ...
        {
            oDv = new DataView(oN.lstConsultaGeneral_PPTOGeneral(sede, cultivo, fundo));
